...
\begin{figure*}[t]
	...
	\caption{Pairwise parameter contours for interferometer and single element experiments probing the pre-reionization dip. See Figure \ref{fig:reionContoursPoly7Poly7} for the simulation set-up.}
