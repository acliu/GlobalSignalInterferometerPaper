...
\subsection{A possible choice of $\M$}
...
This will be the case for the measurements that we consider in this paper, and for $\mathbf{M}$ we pick a diagonal matrix such that
\begin{equation}
\label{eq:diagM}
