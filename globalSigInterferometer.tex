...
\begin{figure*}[!]
	\centering
	\includegraphics[width=1.00\textwidth] {fidModel.png}
...
\begin{figure}[!]
	\centering
	\includegraphics[width=0.5\textwidth] {Haslam_150MHz.pdf}
...
\begin{figure}[t]
	\centering
	\includegraphics[width=0.50\textwidth] {beam_pattern_cartoon.pdf}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.50\textwidth] {uv_cartoon.pdf}
...
\begin{figure}[t]
	\centering
	\includegraphics[width=0.50\textwidth] {effAperture.pdf}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.50\textwidth] {effAperture_PAPER.pdf}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.50\textwidth] {unsub_T0_beamSize.pdf}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.50\textwidth] {subPoly8_T0_beamSize.pdf}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.50\textwidth] {subPoly9_T0_beamSize.pdf}
...
%\begin{figure}[h]
%	\centering
%	%\includegraphics[width=0.55\textwidth] {oldFigures/W_matrix_filler.pdf}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.50\textwidth] {NcomparisonNoSub.pdf}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.50\textwidth] {NcomparisonPoly4.pdf}
...
\begin{table*}[htbp]
   ...
   \end{tabular}
   \caption{\acl{Need to check that I transcribed the new numbers correctly} Parameters, biases, and $1\sigma$ error bars for different scenarios and experiments.}
   % Results here came from /Users/acliu/Research/GlobalSignalInterferometer/results/reionFid_spread_out_beam_variations
   % and /Users/acliu/Research/GlobalSignalInterferometer/results/darkAges_spread_out
   \label{tab:params}
\end{table*}

\begin{figure}[h]
	\centering
	\includegraphics[width=0.5\textwidth] {reionScenarios.pdf}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.5\textwidth] {dipScenarios.pdf}
...
%\begin{figure*}[h]
%	\centering
%	\includegraphics[width=1.00\textwidth,trim=3cm 2cm 3cm 0cm,clip] {reionContoursPoly7Poly6.pdf}
...
\begin{figure*}[t]
	\centering
	\includegraphics[width=1.00\textwidth,trim=3cm 2cm 3cm 0cm,clip] {reionContoursPoly6Poly5.pdf}
...
\begin{figure*}[t]
	\centering
	\includegraphics[width=1.00\textwidth,trim=3cm 2cm 3cm 0cm,clip] {dipContoursPoly7Poly6.pdf}
...
%\begin{figure}[h]
%	\centering
%	%\includegraphics[width=0.55\textwidth] {oldFigures/contours_A_nu0.pdf}
...
%\begin{figure}[h]
%	\centering
%	%\includegraphics[width=0.55\textwidth] {oldFigures/contours_A_sigma.pdf}
%	\caption{\acl{Fill this in}}
%\end{figure}
%
%\begin{figure}[h]
%	\centering
%	%\includegraphics[width=0.55\textwidth] {oldFigures/contours_nu0_sigma.pdf}
%	\caption{\acl{Fill this in}}
%\end{figure}
