...
\end{itemize}
The global signal is defined as the monopole component of the redshifted $21\,\textrm{cm}$ signal, i.e., the angularly averaged $21\,\textrm{cm}$ signal as a function of frequency.  In Figure \acl{insert} we show a fiducial model for the global $21\,\textrm{cm}$ signal, based on the model presented in \citet{PritchardLoeb2010}.  
\begin{itemize}
