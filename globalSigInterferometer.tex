...
\begin{table*}[htbp]
   ...
   \begin{tabular}{@{} llcccccc @{}} % Column formatting, @{} suppresses leading/trailing space
      ...
      \cmidrule(l){2-8} 
      			 & Interferometer Bias &  &  &  &  &  &  \\
			 & Single Element Bias &  &  &  &  &  &  \\			 
      			 & Interferometer Error & $\pm 16$ & $\pm 356$ & $\pm 855$ & $\pm 2$ & $\pm 949$ & $\pm 468$ \\
      			 & Single Element Error  & $\pm 16$ & $\pm 360$ & $\pm 854$ & $\pm 2$ & $\pm 930$ & $\pm 461$ \\
      \midrule
      Moderate & Fiducial Value & 27 & 10.5 & 0.8 & 100 & 70 & 5 \\
      \cmidrule(l){2-8}
			 & Interferometer Bias &  &  &  &  &  &  \\
			 & Single Element Bias &  &  &  &  &  &  \\	
      			 & Interferometer Error & $\pm $ & $\pm $ & $\pm $ & $\pm $ & $\pm $ & $\pm $ \\
      			 & Single Element Error  & $\pm $ & $\pm $ & $\pm $ & $\pm $ & $\pm $ & $\pm $ \\
      \midrule
