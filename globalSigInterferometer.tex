...
\begin{table*}[htbp]
   ...
   \begin{tabular}{@{} llcccccc @{}} % Column formatting, @{} suppresses leading/trailing space
      ...
      \cmidrule(lr){6-8} 
      Model & Experiment & $T_{21}$ & $z_r$ & $\delta z$ & $A$ & $\nu_0$ & $\sigma$\\
      \midrule
      Pessimistic & Interferometer & 16.75398763 & 356.25276456 & 855.66925855 & 2.97731189 & 949.77697322 & 468.32190486 \\
      			 & Single Dipole  & 16.8380905 & 360.06644227 & 854.48767336 & 2.90875735 & 930.74419582 & 461.23575203 \\
      \bottomrule
   \end{tabular}
   \caption{Table of parameters for different reionization scenarios.}
   \label{tab:booktabs}
\end{table*}
